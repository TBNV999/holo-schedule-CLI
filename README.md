...
If you never want to miss any sream, it is recommended to follow the hololive member's Twitter account.  

I will update to add an option to show the schedule without Japanese fonts.
